...
public interface ProductClient {
    ...
    R productIds(@RequestBody ProductCollectParam param);


    @PostMapping("/product/cart/detail")
    Product productDetail(@RequestBody ProductIdParam param);
    ...
    R adminCount(@RequestBody ProductSaveParam param);
